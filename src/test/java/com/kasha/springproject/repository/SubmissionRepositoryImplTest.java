...
public class SubmissionRepositoryImplTest {
    ...
    public void testGetAllSubmissions() {
        ...
        SubmissionsDTO submission1 = new SubmissionsDTO(1, "Submission 1");
        SubmissionsDTO submission2 = new SubmissionsDTO(2, "Submission 2");
        SubmissionsDTO submission3 = new SubmissionsDTO(3, "Submission 3");
    ...
    public void testGetAllSubmissionsEmpty() {
        ...
        public void testGetSubmissionById() {
            SubmissionRepositoryImpl submissionRepository = new SubmissionRepositoryImpl();
            SubmissionsDTO mockSubmission = new SubmissionsDTO(1, "Mock Submission");
        ...
        public void testCreateSubmissionAutoGeneratedId() {
            ...
            mockSubmission.setConsultantName("Mock Submission");
        ...
        public void testUpdateSubmission() {
            ...
            SubmissionsDTO updatedSubmission = new SubmissionsDTO(1, "Updated Submission");

            SubmissionsDTO result = submissionRepository.updateSubmission(1, updatedSubmission);

            assertNotNull(result);
            assertEquals(updatedSubmission, result);
            assertEquals("Updated Submission", result.getConsultantName());
        }
